 ...
 * @property {React.ReactNode} [logoElement]
 */

/**
 * @type {React.ForwardRefExoticComponent<StaggeredMenuProps & React.RefAttributes<any>>}
 */
export const StaggeredMenu = forwardRef(({
  position = 'right',
